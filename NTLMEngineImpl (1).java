...
public final class NTLMEngineImpl implements NTLMEngine {
    ...
    public static class Type1Message extends NTLMMessage {
        ...
        Type1Message(String str, String str2) throws NTLMEngineException {
            try {
                ...
                this.domainBytes = convertDomain != null ? convertDomain.toUpperCase(Locale.US).getBytes("ASCII") : bArr;
            } catch (UnsupportedEncodingException e) {
    ...
    public static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i, String str5, byte[] bArr2) throws NTLMEngineException {
            ...
            this.domainBytes = convertDomain != null ? convertDomain.toUpperCase(Locale.US).getBytes("UnicodeLittleUnmarked") : bArr4;
        ...
        String getResponse() {
            ...
            addUShort(i);
            addULong(i6);
            addULong((this.type2Flags & 128) | (this.type2Flags & 512) | (this.type2Flags & 524288) | NTLMEngineImpl.FLAG_REQUEST_VERSION | (this.type2Flags & 32768) | (this.type2Flags & 32) | (this.type2Flags & 16) | (this.type2Flags & 536870912) | (this.type2Flags & Integer.MIN_VALUE) | (this.type2Flags & 1073741824) | (this.type2Flags & 8388608) | (this.type2Flags & 1) | (this.type2Flags & 4));
            addUShort(261);
            addULong(2600);
            addUShort(3840);
...
© 2022 Mobile Security Framework - MobSF | Ajin Abraham | OpenSecurity.Version v3.5.2 Beta